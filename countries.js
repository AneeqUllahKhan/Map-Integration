    ...
    <>
      <View style={styles.h100}>
        <View
          ...
          <Text style={[styles.fs4, styles.textPrimary]}>Countries</Text>
          <Text style={[styles.fs4, styles.textPrimary]}>{list.length}</Text>
        </View>
          ...
          <ScrollView>
            {list.map((x, i) => (
              <View
                ...
                key={i}>
                <Text style={[styles.textPrimary, styles.fs3]}>{x.name}</Text>
                <Text style={[styles.textSuccess, styles.fs5]}>
                  {x.capital}
                </Text>
                <Text style={styles.textDanger}>{x.country_code}</Text>
                <TouchableOpacity
                  onPress={() => navigation.navigate('Country', x)}>
                  Location
                </TouchableOpacity>
                <TouchableOpacity onPress={() => createRout(x)}>
                  Create Rout
                </TouchableOpacity>
              </View>
            ))}
